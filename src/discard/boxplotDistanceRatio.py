...
for i in [100,150,200]:
    ...
    # sns.boxplot(x="vehicleClass", y="MergingDistanceRatio",data=mergingData[mergingData["location"]==2],hue = "MergingType",showmeans=True,whis = 3,
    #             order=["car","truck","van"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)

    g1 = sns.boxplot(x="MergingType", y="MergingDistanceRatio",data=mergingData[mergingData["location"]==2],hue = "vehicleClass",showmeans=True,whis = 3,
    ...
    # sns.boxplot(x="vehicleClass", y="MergingDistanceRatio",data=mergingData[mergingData["location"]==3],hue = "MergingType",showmeans=True,whis = 3,
    #             order=["car","truck","van"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)

    g2 = sns.boxplot(x="MergingType", y="MergingDistanceRatio",data=mergingData[mergingData["location"]==3],hue = "vehicleClass",showmeans=True,whis = 3,
               order=["A", "B", "C","D", "E", "F","G"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    ...
    g3 = sns.boxplot(x="MergingType", y="MergingDistanceRatio",data=mergingData[mergingData["location"]==5],hue = "vehicleClass",showmeans=True,whis = 3,
               order=["A", "B", "C","D", "E", "F","G"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    ...
    g4 = sns.boxplot(x="MergingType", y="MergingDistanceRatio",data=mergingData[mergingData["location"]==6],hue = "vehicleClass",showmeans=True,whis = 3,
               order=["A", "B", "C","D", "E", "F","G"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0, 0.2, 0.4, 0.6, 0.8, 1, 1.2])
...
plt.tight_layout()
# plt.show()
plt.savefig(root_path+"/asset/JSDivergence/BoxplotDistanceRatio.png", dpi=800)
# plt.clf()
