...
for i in [100,150,200]:
    ...
    mergingData = mergingData[mergingData["trafficFlowArea4"] !=0 ]

    ax1 = plt.subplot(3, 4, 4 * j + 1)
    g1 = sns.scatterplot(x="trafficSpeedArea4", y="trafficFlowArea4", data=mergingData[(mergingData["location"] == 2) & (mergingData["vehicleClass"] == "car")], hue='MergingType')
    ...
    g2 = sns.scatterplot(x="trafficDensityArea4", y="trafficFlowArea4", data=mergingData[(mergingData["location"] == 2) & (mergingData["vehicleClass"] == "car")], hue='MergingType')
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    g2.set(xlabel=None)
    plt.ylabel("TTC(s)", font1)
    ...
    g3 = sns.scatterplot(x="trafficSpeedArea5", y="trafficFlowArea5", data=mergingData[(mergingData["location"] == 2) & (mergingData["vehicleClass"] == "car")], hue='MergingType')
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    g3.set(xlabel=None)
    plt.ylabel("TTC(s)", font1)
    ...
    g4 = sns.scatterplot(x="trafficDensityArea5", y="trafficFlowArea5", data=mergingData[(mergingData["location"] == 2) & (mergingData["vehicleClass"] == "car")], hue='MergingType')
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    g4.set(xlabel=None)
    plt.ylabel("TTC(s)", font1)
