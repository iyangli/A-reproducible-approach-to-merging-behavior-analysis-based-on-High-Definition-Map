...
for i in [100,150,200]:
    ...
    mergingData['MinimumLeadHeadway'] = mergingData['MinimumLeadHeadway'].astype('float')
    ...
    g1 = sns.boxplot(x="MergingType", y="MinimumLeadHeadway",data=mergingData[mergingData["location"]==2],hue = "vehicleClass",showmeans=True,whis = 1.5,
    ...
    g2 = sns.boxplot(x="MergingType", y="MinimumLeadHeadway",data=mergingData[mergingData["location"]==3],hue = "vehicleClass",showmeans=True,whis = 1.5,
                order=["B", "C", "E", "F"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0,2,4,6,8,10])
    ...
    g3 = sns.boxplot(x="MergingType", y="MinimumLeadHeadway",data=mergingData[mergingData["location"]==5],hue = "vehicleClass",showmeans=True,whis = 1.5,
               order=["B", "C", "E", "F"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0,2,4,6,8,10])
    ...
    g4 = sns.boxplot(x="MergingType", y="MinimumLeadHeadway",data=mergingData[mergingData["location"]==6],hue = "vehicleClass",showmeans=True,whis = 1.5,
                order=["B", "C", "E", "F"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0,2,4,6,8,10])
