...
for i in [100,150,200]:
    ...
    mergingData= mergingData[(mergingData["MinimumRearDistance"]!="None") & (mergingData["MinimumRearDistance"]!="999")]
    mergingData['MinimumRearDistance'] = mergingData['MinimumRearDistance'].astype('float')
    ...
    g1 = sns.boxplot(x="MergingType", y="MinimumRearDistance",data=mergingData[mergingData["location"]==2],hue = "vehicleClass",showmeans=True,whis = 1.5,
    ...
    g2 = sns.boxplot(x="MergingType", y="MinimumRearDistance",data=mergingData[mergingData["location"]==3],hue = "vehicleClass",showmeans=True,whis = 1.5,
                order=[ "D", "E", "F"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0,40,80,120,160,200])
    ...
    g3 = sns.boxplot(x="MergingType", y="MinimumRearDistance",data=mergingData[mergingData["location"]==5],hue = "vehicleClass",showmeans=True,whis = 1.5,
                order=["D", "E", "F"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0,40,80,120,160,200])
    ...
    g4 = sns.boxplot(x="MergingType", y="MinimumRearDistance",data=mergingData[mergingData["location"]==6],hue = "vehicleClass",showmeans=True,whis = 1.5,
                order=[ "D", "E", "F"],meanprops = {'marker':'D','markerfacecolor':'red'},palette="hls",saturation=0.6, showfliers = True)
    plt.xticks(fontsize=FONTSIZE)
    plt.yticks(fontsize=FONTSIZE)
    plt.yticks([0,40,80,120,160,200])
